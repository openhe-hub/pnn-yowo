...
from .pnn_modules import PnnBaseModule
...
class PPOActor(nn.Module):
    def __init__(self,
        ...
        self.actor_module = PnnBaseModule(obs_dim_dict, module_config_dict)
    ...
    def new_task(self, task_id):
        ...
        self.actor_module.freeze_columns()
        self.actor_module.new_task()
    
    def parameters(self):
        return self.actor_module.parameters(col=self.task_id)
...
class PPOCritic(nn.Module):
    def __init__(self,
        ...
        self.critic_module = PnnBaseModule(obs_dim_dict, module_config_dict)
    ...
    def new_task(self, task_id):
        self.task_id = task_id
        self.critic_module.freeze_columns()
        self.critic_module.new_task()
    
    def parameters(self):
        return self.critic_module.parameters(col=self.task_id)

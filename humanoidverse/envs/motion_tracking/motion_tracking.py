...
class LeggedRobotMotionTracking(LeggedRobotBase):
    ...
    def reset_motion_file(self, config):
        self.config.robot.motion.motion_file = config.robot.motion.motion_file

        self._init_motion_lib()

        logger.success(f"Successfully reset motion file to {config.robot.motion.motion_file}")
